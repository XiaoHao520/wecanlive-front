<template>
  ...
  <edit-view :model="model"
    ...
    <div slot="after" class="prize">
      <v-button size="small" class="btn-add" @click="add_item">添加名次區間</v-button>
      <table>
        <th>名次區間</th>
        <th>獎勵內容</th>
        <tbody>
      ...
      <v-modal title="選擇獎勵" :visible="showModal" @ok="submit" @cancel="showModal=false" :width="1000"
        ...
        <v-input-number :min="1" v-if="prize_type!=='prize' && prize_type!=='badge'"
